...
class Doktor extends Calisan {
    ...
    List<String> DoktorIsim = new LinkedList<>();
    List<String> DoktorCinsiyet = new LinkedList<>();
    List<Long> DoktorTC = new LinkedList<>();
    List<Integer> DoktorYas = new LinkedList<>();
    List<Integer> DoktorMaas = new LinkedList<>();
    List<String> DoktorTelNO = new LinkedList<>();
    ...
    public void HastaSil() {
        ...
        for (int i = 0; i< hasta.HastaTC.size();i++){
            if (hasta.HastaTC.get(i).equals(TCKontrol)){
                ...
                hasta.HastaTelNO.remove(i);
                hasta.HastaKanDegeri.remove(i);
