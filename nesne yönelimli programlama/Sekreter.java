...
class Sekreter extends Calisan {
    ...
    List<String> SekreterIsim = new LinkedList<>();
    List<String> SekreterCinsiyet = new LinkedList<>();
    List<Long> SekreterTC = new LinkedList<>();
    List<Integer> SekreterYas = new LinkedList<>();
    List<String> SekreterTelNO = new LinkedList<>();
